...
<div id="wrapper">
	...
	<div id="page-wrapper">
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-lg-12">
					<h2 class="page-header">Find test questions</h2>
				</div>
			</div>
			<!-- /.row -->
			<div class="container col-lg-12">
				<div class="alert alert-info col-lg-8" role="alert">
					To find a test question do the following: <br>
					...
					4) On the "Test details" page click on "View questions" button.
					<br><br>
					Note: "View questions" button will appear only if questions have been added to the test.
				</div>
			</div>
		</div>
		<!-- /.container-fluid -->
