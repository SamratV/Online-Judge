...
<div id="wrapper">
	...
	<div id="page-wrapper">
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-lg-12">
					<h2 class="page-header">Disapproved users</h2>
					<small class="text-muted">
						List of users whose account haven't been approved by the Admin.
					</small>
				</div>
			</div>
			<!-- /.row -->
			<div class="col-lg-12">
				...
				<table class="table table-striped">
					...
					<tbody>
					<%
						PreparedStatement stmt = link.prepareStatement("SELECT u.fullname, u.username, u.profession, (SELECT dept_name FROM dept WHERE dept_id=u.dept_id) AS dept FROM users AS u WHERE u.approved=0 LIMIT ?, ?");
			...
			<%
				Pager pager = new Pager(pageno, per_page, ValidateField.countDisapproved());
