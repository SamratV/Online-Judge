	        ...
	        <div id="page-wrapper">
	            ...
	            <div class="container-fluid">
	                ...
	                <div class="container col-lg-12">
	                	<form method="post" action="../UQStatement" onsubmit="return checkQuestion();">
							...
							<div class="form-group">
								...
								<select class="form-control" id="qcat" name="qcat" required="required">
									<option selected disabled>-- Select --</option>
									<%
							...
							<div class="form-group">
								...
								<select class="form-control" id="qscat" name="qscat" required="required" disabled>
								</select>
							</div>
							<div class="form-group">
