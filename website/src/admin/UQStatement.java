...
public class UQStatement extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if(ValidateField.checkQuestion(qtitle, qmarks, qtc_public, qtc_private, qstatement)) {
				String query = "INSERT INTO questions (qtitle, qstatement, qtc_public, qtc_private, qmarks, scid) VALUES(?,?,?,?,?,?)";
				...
				stmt.setInt(6, Integer.parseInt(qscat));
				stmt.executeUpdate();
